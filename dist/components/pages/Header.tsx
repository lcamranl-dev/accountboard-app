...
const Header: React.FC<HeaderProps> = ({ activePage, user, searchTerm, onSearchChange, notifications, onMarkNotificationsRead, onMenuClick }) => {
    ...
    const pageTitles: { [key: string]: string } = {
        Dashboard: t('dashboard'), Transactions: t('transactions'), Projects: t('projects'), Services: t('servicesAndExpenses'),
        Customers: t('customers'), Employees: t('employees'), Collaborators: t('collaborators'), Accounts: t('accounts'), Reports: t('reports'), Settings: t('settings'), AuditLog: t('auditLog'),
    };
